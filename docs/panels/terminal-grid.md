...
plugin.Panel{
    ...
    Source: &plugin.DataSource{RouteID: "myplugin.shell", Method: plugin.MethodWS},
...
```go
plugin.Stream{ID: "myplugin.shell", Kind: plugin.StreamTerminal, RouteID: "myplugin.shell"}
```
